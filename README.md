...
# 🛡️ Malicious URL & Phishing Detector
...
* **🛡️ Smart Authority Whitelisting:** Bypasses prediction on recognized high-authority domains (e.g., `github.com`, `google.com`) to eliminate false positives.
